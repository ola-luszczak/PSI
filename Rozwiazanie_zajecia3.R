...
file_path <- "~/psi/Biden - First address to Congress_2021.txt"
...
file_paths <- c("~/psi/Biden - First address to Congress_2021.txt", "~/psi/Biden - State of the Union 2024.txt")  # Uzupełnij nazwy plików i ustaw Working Directory!
